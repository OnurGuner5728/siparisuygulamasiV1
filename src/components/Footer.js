        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><Link href="/profil" className="text-gray-600 hover:text-orange-500 text-sm">Hesabım</Link></li>
                <li><Link href="/profil/siparisler" className="text-gray-600 hover:text-orange-500 text-sm">Siparişlerim</Link></li>
                <li><Link href="/profil/adresler" className="text-gray-600 hover:text-orange-500 text-sm">Adreslerim</Link></li>
                <li><Link href="/favori-restoranlar" className="text-gray-600 hover:text-orange-500 text-sm">Favori Restoranlar</Link></li>
              </ul>
            </div>
            <div>
              <h3 className="text-lg font-semibold mb-4">Destek</h3>
              <ul className="space-y-3">
                <li><Link href="/hakkimizda" className="text-gray-600 hover:text-orange-500 text-sm">Hakkımızda</Link></li>
                <li><Link href="/iletisim" className="text-gray-600 hover:text-orange-500 text-sm">İletişim</Link></li>
                <li><Link href="/yardim" className="text-gray-600 hover:text-orange-500 text-sm">Yardım</Link></li>
                <li><Link href="/kullanim-kosullari" className="text-gray-600 hover:text-orange-500 text-sm">Kullanım Koşulları</Link></li>
              </ul>
            </div>
          </div>
