            ...
            <div className="md:col-span-2">
              ...
              <div className="flex items-center space-x-6">
                ...
                <div className="flex-1">
                  <label htmlFor="image" className="cursor-pointer bg-white py-2 px-3 border border-gray-300 rounded-md shadow-sm text-sm leading-4 font-medium text-gray-700 hover:bg-gray-50 dark:bg-gray-900 focus:outline-none">
                    Görsel Seç
                  </label>
                  <input 
                    id="image" 
